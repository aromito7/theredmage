<?php
	...
	$portfolioId	= "9PO203SK7";
	$forwardDomain	= "http://cdn.searchesmagnified.com/";	
	...
	$domain                 = urlencode(safeReturn( $_SERVER, 'HTTP_HOST' ));
	...
	$url = $forwardDomain."sk-rcpark.php?dn=".$domain."&ua=".$userAgent."&requrl=".$originalURL."&al=".$languageHeader."&reqref=".$referrer."&pid=".$portfolioId."&ip=".$ipAddress."&xfip=".$xIP;
